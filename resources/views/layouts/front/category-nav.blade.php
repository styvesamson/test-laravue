                                ...
                                <li>
                                        ...
                                        <ul>
                                                ...
                                                <li>
                                                        <a href="#">clothing</a>
                                                        <ul>
                                                                <li><a target="_blank" href="index-2.html">fashion 1</a></li>
                ...
                <div class="icon-nav">
                        <ul>
                                <li class="onhover-div mobile-search">
                                        <div><img src="images/icon/search.png" onclick="openSearch()" class="img-fluid blur-up lazyload" alt=""> <i class="ti-search" onclick="openSearch()"></i></div>
                                ...
                                <li class="onhover-div mobile-setting">
                                        <div><img src="images/icon/setting.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-settings"></i></div>
                                ...
                                <li class="onhover-div mobile-cart">
                                        <div><img src="images/icon/cart.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-shopping-cart"></i></div>
                                        <ul class="show-div shopping-cart">
                                                <li>
                                                        <div class="media">
                                                                <a href="#"><img alt="" class="mr-3" src="images/fashion/product/1.jpg"></a>
                                                ...
                                                <li>
                                                        <div class="media">
                                                                <a href="#"><img alt="" class="mr-3" src="images/fashion/product/2.jpg"></a>
                                                                <div class="media-body">
                                                                        <a href="#">
                                                                                <h4>item name</h4>
                                                                        </a>
