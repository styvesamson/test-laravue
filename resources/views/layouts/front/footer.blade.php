            ...
            <div class="row footer-theme partition-f">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-contant">
                        <div class="footer-logo"><img src="images/icon/logo.png" alt=""></div>
                ...
                <div class="col offset-xl-1">
                    <div class="sub-title">
                        <div class="footer-title">
                            <h4><a href="{{ route('accounts', ['tab' => 'profile']) }}">my account</a></h4>
                        </div>
                        <div class="footer-contant">
                            <ul>
                                <li><a href="#">mens</a></li>
                    ...
                    <div class="sub-title">
                        ...
                        <div class="footer-contant">
                            <ul class="contact-list">
                                <li><i class="fa fa-map-marker"></i>{{ config('app.name') }} Demo Store</li>
                                <li><i class="fa fa-phone"></i>Call Us: 123-456-7898</li>
                                <li><i class="fa fa-envelope-o"></i>Email Us: <a href="{{ config('app.url') }}"">Support@Fiot.com</a></li>
