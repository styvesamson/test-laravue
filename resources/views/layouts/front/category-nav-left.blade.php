<div class="menu-left">
                                                ...
                                                <ul class="mega-menu clothing-menu">
                                                        <li>
                                                                <div class="row m-0">
                                                                        ...
                                                                        <div class="col-xl-4">
                                                                                <a href="#" class="mega-menu-banner"><img src="images/mega-menu/fashion.jpg" alt="" class="img-fluid blur-up lazyload"></a>
                                                                        </div>
                                                                </div>
                                                        </li>
                                                </ul>
        ...
        <div class="brand-logo">
                <a href="index-2.html"><img src="images/icon/logo.png" class="img-fluid blur-up lazyload" alt=""></a>
        </div>
</div>
