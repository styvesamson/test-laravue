                    ...
                    <ul class="header-dropdown">
                        ...
                        <li class="onhover-dropdown mobile-account"> <i class="fa fa-user" aria-hidden="true"></i> My Account
                         ...
                         <ul class="onhover-show-div">
                             @if(auth()->check())
                             <li><a href="{{ route('accounts', ['tab' => 'profile']) }}" data-lng="en"><i class="fa fa-home"></i>My Profile</a></li>
                             <li><a href="{{ route('logout') }}" data-lng="es"><i class="fa fa-sign-out"></i> Logout</a></li>
                             @else
                             <li><a href="{{ route('login') }}" data-lng="en"> <i class="fa fa-lock"></i> Login</a></li>
                             <li><a href="{{ route('register') }}" data-lng="es"><i class="fa fa-sign-in"></i> Register</a></li>
                             @endif
                         </ul>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg">
                                ...
                                <div class="offer-content"> <img src="images/Offer-banner.png" class="img-fluid blur-up lazyload" alt="">
                                    <h2>newsletter</h2>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img"><img src="images/pro3/1.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                    </div>
    ...
    <div class="setting_box_body">
        ...
        <div class="setting-body">
                ...
                <div class="row demo-section">
                    <div class="col-sm-6 col-12 text-center demo-effects">
                        <div class="set-position">
                            ...
                            <div class="demo-text">
                                <h4>Fashion</h4>
                                <div class="btn-group demo-btn" role="group" aria-label="Basic example"> <button type="button" onClick="window.open('index-2.html')" class="btn new-tab-btn">Preview</button></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-12 text-center demo-effects">
            ...
            <div class="buy_btn">
                ...
                <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3" target="_blank" class="btn btn-block purchase_btn"><img src="images/icon/angular.png" alt="" class="img-fluid"> Multikart Angular</a>
                <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2" target="_blank" class="btn btn-block purchase_btn"><img src="images/icon/react.png" alt="" class="img-fluid"> Multikart React</a>
                <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1" target="_blank" class="btn btn-block purchase_btn"><img src="images/icon/shopify.png" alt="" class="img-fluid"> Multikart Shopify</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg">
                                ...
                                <div class="media">
                                    <img src="images/stop.png" class="stop img-fluid blur-up lazyload mr-3" alt="">
